<div id="user-login-form" class="max-w-md mx-auto mt-10 bg-white rounded-lg shadow-md overflow-hidden p-6">
    ...
    <form>
        ...
        <div class="mt-4 text-center">
            <p class="text-sm text-gray-600">
                ...
                <a href="{{ route('user.register') }}" class="text-blue-500 hover:text-blue-600 hover:underline">Register here</a>
            </p>
        </div>
    </form>
</div>
